...
export class FaceNetNchw {
  ...
  async load(contextOptions) {
    ...
    const mixed6a_pool = block35_5
        .then((block35_5) => this.builder_.maxPool2d(block35_5, poolOptions));
    ...
    const block17_2 = this.buildBlock17_(
        block17_1, 2, ['947', '918', '906', '1069', '1148']);
    const block17_3 = this.buildBlock17_(
        block17_2, 3, ['1087', '932', '1028', '1150', '1137']);
    const block17_4 = this.buildBlock17_(
        block17_3, 4, ['1089', '1039', '1001', '1135', '1129']);
    const block17_5 = this.buildBlock17_(
        block17_4, 5, ['1123', '898', '1090', '1105', '920']);
    const block17_6 = this.buildBlock17_(
        block17_5, 6, ['935', '998', '1143', '1061', '1049']);
    const block17_7 = this.buildBlock17_(
        block17_6, 7, ['1118', '1023', '1013', '1092', '1093']);
    const block17_8 = this.buildBlock17_(
        block17_7, 8, ['1141', '1024', '1140', '929', '1120']);
    const block17_9 = this.buildBlock17_(
        block17_8, 9, ['1067', '908', '1142', '1003', '1074']);
    const block17_10 = this.buildBlock17_(
        block17_9, 10, ['1078', '913', '1138', '982', '967']);

    // Mixed 7a branches
    const mixed7a_pool = block17_10
        .then((block17_10) => this.builder_.maxPool2d(block17_10, poolOptions));
    ...
    const block8_2 = this.buildBlock8_(
        block8_1, 2, ['999', '1144', '1102', '1097', '981']);
    const block8_3 = this.buildBlock8_(
        block8_2, 3, ['962', '934', '1064', '1052', '1042']);
    const block8_4 = this.buildBlock8_(
        block8_3, 4, ['915', '957', '1000', '1034', '1071']);
    const block8_5 = this.buildBlock8_(
